...
| Feature | Description |
| :--- | :--- |
| 🚀 **Smart Query Expansion** | **New!** ระบบขยายความเข้าใจคำถามสั้นๆ ให้ครอบคลุมก่อนค้นหา (เช่น "ลงทะเบียน" -> "ขั้นตอนและช่วงเวลา...") |
| ⚡ **True Streaming** | **New!** ตอบกลับทันทีแบบ Real-time Character-by-Character ไม่ต้องรอนาน |
...
| 🛡️ **Advanced Guardrails** | กรองเนื้อหาที่ไม่เหมาะสมและควบคุม Persona พี่สวนดุสิตให้ปลอดภัยและน่าเชื่อถือ |
| 🌙 **Premium UI** | ธีม Dark Mode สไตล์ Gemini พร้อม animation และแสดงแหล่งอ้างอิง |
